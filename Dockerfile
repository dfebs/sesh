...
# docker build -t sesh .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name sesh sesh
...
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y curl libjemalloc2 libvips sqlite3 wget && \
