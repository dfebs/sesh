class WorkoutSet < ApplicationRecord
  ...
  validates :amount_imp, presence: true, numericality: { greater_than: 0.000001, less_than_or_equal_to: 15000 }
  validates :amount_metric, presence: true, numericality: { greater_than: 0.00001, less_than_or_equal_to: 15000 }
